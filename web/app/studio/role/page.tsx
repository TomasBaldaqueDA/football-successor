...
export const metadata = {
  title: "Role · Football Successor",
  description: "Role replacement (same bucket/outcome) ranking",
};
    ...
    <div className="flex min-h-full flex-col bg-zinc-50 dark:bg-black">
      <nav className="border-b border-zinc-200 bg-white px-4 py-3 dark:border-zinc-800 dark:bg-zinc-950">
        <div className="mx-auto flex max-w-4xl items-center gap-4 text-sm">
          ...
          <span className="font-medium text-zinc-900 dark:text-zinc-100">Studio · Role</span>
        </div>
      </nav>
      <RoleStudio />
    </div>
